...
class Calcuator extends JFrame implements ActionListener {
    ...
    Calcuator() {
        ...
        button = JButton[10];
        //creating button 0 to 9
        for (int i= 0; i < 10; i++) {
            button[i] = new JButton("" + (i));
        }
        //creating math operator button
        ...
        //adding action listener to button with their methods 
   ...
   button[2].addActionListener(
    ...
    button[8].addActionListener(
        new ActionListener()  {
         public void actionPerformed(ActionEvent e)  {
           String buttontext = tf.getText() + dec.getText();
           tf.setText(buttontext);
         }
      }
    );
    button[9].addActionListener(
     ...
     add.addActionListener(
         new ActionListener()   {
             public void actionPerformed(ActionEvent e)  {
              String buttontext = tf.getText() + add.getText();
     ...
     clr.addActionListener(
       ...
       btnpanel.add(button[7]);btnpanel.add(button[8]);btnpanel.add(button[9]);btnpanel.add(div);
