...
class CClassmethod extends Frame{
       static String ln="";
       ...
       CClassmethod(){
        ...
        public void paint(Graphics g){
                ...
                Font fn;
                //set methods
                this.setBackgroud(new Color(200,80,50));
                this.setForeground(new Color(10,0,180));
                g.fillRect(25,45,80,40);
        ...
        g.drawString("Font Color = "+fc,20,17);
        g.drawString(Font = "+fn,20,190);
        g.drawString("Components Name = "+ln,20,210);
        g.drawString("Size of Frame = "+size,20,230);
        g.drawString("Height of Frame = "+height,20,270);
...
public static void main(String[] args)  {
       CClassmethod c1=new CClassmethod();
       Label l1=new Label1(" This is a Label ");
